...
var mOutput = Double2(nGridCapital, rows: nGridProductivity)
var mValueFunction = Double2(nGridCapital, rows: nGridProductivity)
var mValueFunctionNew = Double2(nGridCapital, rows: nGridProductivity)
var mPolicyFunction = Double2(nGridCapital, rows: nGridProductivity)
var expectedValueFunction = Double2(nGridCapital, rows: nGridProductivity)
